...
/* package apters-0.1 */
#define VERSION_apters "0.1"
#define MIN_VERSION_apters(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package blaze-builder-0.3.0.1 */
#define VERSION_blaze_builder "0.3.0.1"
...
/* package mime-mail-0.3.0.2 */
#define VERSION_mime_mail "0.3.0.2"
#define MIN_VERSION_mime_mail(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 0)

/* package persistent-0.5.1 */
#define VERSION_persistent "0.5.1"
#define MIN_VERSION_persistent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 1)

/* package persistent-sqlite-0.5.0 */
#define VERSION_persistent_sqlite "0.5.0"
#define MIN_VERSION_persistent_sqlite(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 0)

/* package persistent-template-0.5.1 */
#define VERSION_persistent_template "0.5.1"
...
/* package wai-extra-0.4.0.3 */
#define VERSION_wai_extra "0.4.0.3"
...
/* package yesod-static-0.1.0.1 */
#define VERSION_yesod_static "0.1.0.1"
